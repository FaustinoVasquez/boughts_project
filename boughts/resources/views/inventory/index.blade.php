...
@stop
@section('formSearch')
    @include('inventory.shared._formSearch',[$partNumbers,$categories])
    @parent
@stop
            ...
            <div class="col-lg-12 ">
                <div class="card panel-primary filterable">
                    <div class="card-heading">
                        <h3 class="card-title">
                            <i class="livicon" data-name="users" data-size="16" data-loop="true" data-c="#fff"
                               data-hc="white"></i> Inventory Global
                        </h3>
                    ...
                    <div class="card-body table-responsive-lg table-responsive-md table-responsive-sm">
                        <table class="table table-striped table-bordered display nowrap " id="inventory-table"
                               width="100%">
                            <thead>
                            <tr>
                                <th></th>
...
@push('footer_scripts')
    ...
    <script>
        ...
        $(function () {
            ...
            $catalogTable = $('#inventory-table').DataTable({
                pageLength: 25,
                ...
                ajax: {
                    ...
                    data: function (d) {
                        ...
                        d.category = $('select[name=hasCategory]').val();
                ...
                columns: [
                    ...
                    {"data": "NewQty",name:"NewQty"},
                    {"data": "UsedQty",name:"UsedQty"},
                    {"data": "CNQty",name:"CNQty"},
                    {"data": "NoCoverQty",name:"NoCoverQty"},
                    {"data": "DENewQty",name:"DENewQty"},
                    {"data": "DEUsedQty",name:"DEUsedQty"},
                    {"data": "DECNQty",name:"DECNQty"},
                ],
                columnDefs: [
                    {
                        targets: 0,
        ...
        {{--$(document).on('click', '#show-launch-btn', function (e) {--}}
        {{--e.preventDefault();--}}
        {{--let tr = $(this).closest('tr');--}}
        {{--let sku = tr.attr('id');--}}
        {{--let row = $catalogTable.row(tr);--}}
